...
export default function MemoryCard({ post, index }: MemoryCardProps) {
    ...
    return (
        <>
            <Card
                className={`border-2 border-rose-200 shadow-lg bg-white/90 backdrop-blur-sm transform ${rotation} hover:scale-105 transition-all duration-300 hover:shadow-xl cursor-pointer`}
